        ...
        <SafeAreaView>
            <View style={tw`mt-40`}>
                <View style={tw`mx-8`}>
                    ...
                    <View style={tw`my-4`}>
                        <PrimaryButton title='Masuk' warnaBtn='[#0086FF]' rute={() => navigation.push('/(tabs)/home')} />
                        <Text style={tw`text-center text-sm text-white`}>Belum punya akun? <Text style={tw`text-[#0086FF] font-bold`} onPress={() => navigation.push("/auth/signup")}>Daftar dulu!</Text></Text>
                    </View>
